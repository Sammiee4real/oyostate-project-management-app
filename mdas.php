...
<div class="app-content content">
    ...
    <div class="content-header row">
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">View MDAs</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="home">Home</a>
                  </li>
                  <li class="breadcrumb-item"><a href="add_mda">Add MDA</a>
                  </li>
                  <li class="breadcrumb-item active">View MDAs
                  </li>
                </ol>
              </div>
            </div>
          ...
          <div class="content-header-right col-md-4 col-12">
            <div class="btn-group float-md-right">
              <a href="add_mda"  class="btn btn-success">Add MDA <i class="ft-thumbs-up position-right"></i></a>
            </div>
          </div>
                ...
                <div class="table-responsive table-bordered table-striped">
                    ...
                    <table id="recent-orders" class="table table-hover mb-0">
                        ...
                        <tbody>
                          ...
                          foreach ($mdas as $mda) { ?>      
                            <tr>
                                <td class="text-truncate"><?php echo $mda['mda_name']; ?></td>
                                <td class="text-truncate">
                                <?php 
                                 $added_by = $mda['added_by'];
                                ...
                                <td class="text-truncate"><?php echo $mda['date_added']; ?></td>
                            </tr>
                          <?php } 
                            }
                          ?>
