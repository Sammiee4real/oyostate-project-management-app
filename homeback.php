                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-underline no-hover-bg nav-justified">
                            ...
                            <?php $count = 1; foreach ($project_phases as $project_phase) {       if($count == 1){
                                   echo '<li class="nav-item">
                                    <a class="nav-link active" id="active-tab'.$count.'" data-toggle="tab" href="#active'.$count.'" aria-controls="active'.$count.'" aria-expanded="true">'.$project_phase['phase_name'].'</a>
                                    </li>';
                                }else{
                                    echo '<li class="nav-item">
                                    <a class="nav-link" id="link-tab'.$count.'" data-toggle="tab" href="#link'.$count.'" aria-controls="link'.$count.'" aria-expanded="false">'.$project_phase['phase_name'].'</a>
                                    </li>';
                                }
                             ?>
                        ...
                        <div class="tab-content px-1 pt-1">
                            <?php for($i=1; $i <= $count; $i++ ): 
                                if($i == 1){
                                ?>
                            <div role="tabpanel" class="tab-pane active" id="active<?php echo $i; ?>" aria-labelledby="active-tab<?php echo $i; ?>" aria-expanded="true">
                            
                                <p>Macaroon<?php echo $i; ?></p>
                    ...
                    <table id="recent-orders" class="table  table-hover mb-0">
                        ...
                        <tbody>
                          ...
                          ?>
                            ...
                            <?php }else{?>
                            <div class="tab-pane" id="link<?php echo $i; ?>" role="tabpanel" aria-labelledby="link-tab<?php echo $i; ?>" aria-expanded="false">
                                <p>Chocolate<?php echo $i; ?> bar gummies sesame snaps. Liquorice cake sesame snaps cotton candy cake sweet brownie. Cotton candy candy canes brownie. Biscuit pudding sesame snaps pudding pudding sesame snaps biscuit tiramisu.</p>
                            </div>
                        <?php } endfor ?>
